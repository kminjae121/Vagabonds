...
namespace _Code.KDH.MovementTest
{
    public class MovementTestCourseController : MonoBehaviour
    {
        ...
        private void BuildCourse()
        {
            ...
            CreateBlock("Slide Practice Side Lane", new Vector3(-22f, -0.05f, 48f), new Vector3(16f, 0.24f, 32f), !_useSingleRunwayFloorCollision);
            CreateBlock("Slide Low Ceiling A", new Vector3(-22f, 1.38f, 44f), new Vector3(16f, 0.24f, 10f));
            CreateBlock("Slide Low Ceiling B", new Vector3(-22f, 1.38f, 56f), new Vector3(16f, 0.24f, 10f));
            CreateBlock("Slide Jump Check Landing", new Vector3(-22f, 0.45f, 74f), new Vector3(12f, 0.24f, 8f));
